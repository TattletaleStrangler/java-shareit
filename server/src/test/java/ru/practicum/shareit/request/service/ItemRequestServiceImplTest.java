...
class ItemRequestServiceImplTest {
    ...
    void findAllByRequesterId() {
        ...
        LocalDateTime createdItemRequest1 = LocalDateTime.now().minusMinutes(10);
        LocalDateTime createdItemRequest2 = LocalDateTime.now().minusMinutes(5);
        LocalDateTime createdItemRequest3 = LocalDateTime.now().minusMinutes(1);

        ItemRequest itemRequest1 = ItemRequest.builder()
                .description("Описание запроса 1")
                .created(createdItemRequest1)
        ...
        ItemRequest itemRequest2 = ItemRequest.builder()
                ...
                .created(createdItemRequest2)
                .requester(requester1)
                .build();
        em.persist(itemRequest2);

        ItemRequest itemRequest3 = ItemRequest.builder()
                .description("Описание запроса 3")
                .created(createdItemRequest3)
        ...
        assertThat(savedItemRequestsDto.get(0).getCreated(), equalTo(createdItemRequest2));
        ...
        assertThat(savedItemRequestsDto.get(1).getCreated(), equalTo(createdItemRequest1));
